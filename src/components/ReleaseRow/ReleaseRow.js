  ...
  render() {
    ...
    return (
      <tr className="ReleaseRow">
        <td>
          <ExternalLink to={release.html_url}>{this.releaseName}</ExternalLink>
        </td>
        <td>
          <GithubAvatar author={release.author} />
        </td>
        <td>
          <FormattedDate date={release.published_at} />
        </td>
        {/* Podemos aplicar estilos inline usando objetos */}
        <td style={{ width: "185px" }}>
          <ExternalLink
            to={release.zipball_url}
            className="ReleaseRow__Button button button-primary"
          >
            .zip
          </ExternalLink>
          <ExternalLink
            to={release.tarball_url}
            className="ReleaseRow__Button button"
          >
            .tgz
          </ExternalLink>
        </td>
